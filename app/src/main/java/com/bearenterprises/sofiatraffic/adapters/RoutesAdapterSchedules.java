...
public class RoutesAdapterSchedules extends ExpandableRecyclerAdapter<DirectionSchedules, Stop, DirectionViewHolder, StopViewHolder> {
    private Context context;
    private LayoutInflater mInflater;
    private int highlightedPositionParent = -1, highlightedPositionChild =-1;
    public RoutesAdapterSchedules(@NonNull List<DirectionSchedules> parentList, Context context) {
        super(parentList);
    ...
    @Override
    public void onBindParentViewHolder(@NonNull DirectionViewHolder parentViewHolder, int parentPosition, @NonNull DirectionSchedules parent) {
