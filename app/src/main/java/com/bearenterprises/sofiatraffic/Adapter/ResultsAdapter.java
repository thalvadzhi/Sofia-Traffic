package com.bearenterprises.sofiatraffic.Adapter;
...
//            holder.times = (TextView) convertView.findViewById(R.id.times);
        ...
        switch(vt.getType()){
            case "0": holder.imageView.setBackgroundColor(Color.parseColor("#0000FF"));
            ...
            case "1": holder.imageView.setBackgroundColor(Color.parseColor("#EE7600"));
